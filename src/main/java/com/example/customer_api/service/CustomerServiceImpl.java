...
public class CustomerServiceImpl implements CustomerService {
    ...
    public List<CustomerResponseDTO> getCustomersByStatus(String status) {
        try {
            ...
            throw new IllegalArgumentException("Invalid status: " + status + ". Valid values are: ACTIVE, INACTIVE");
        }
    }
    ...
    public CustomerResponseDTO partialUpdateCustomer(Long id, CustomerUpdateDTO updateDTO) {
        ...
        if (updateDTO.getStatus() != null) {
            try {
                ...
                throw new IllegalArgumentException("Invalid status: " + updateDTO.getStatus() + ". Valid values are: ACTIVE, INACTIVE");
            }
        }
